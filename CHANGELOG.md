...
## 3.5.0 - January 13, 2026

- Changed: Use VSCode built-in commands for extension management.

- Changed: Remove `http_proxy` setting in `syncing.json` and use VSCode's `http.proxy` instead.
